...
export const Stethoscope = createIcon(
  <>
    <path d="M4.8 2.3A.3.3 0 0 0 4.5 2.5V8a5 5 0 0 0 5 5h3a5 5 0 0 0 5-5V2.5a.3.3 0 0 0-.3-.3h-1.4a.3.3 0 0 0-.3.3V8a3 3 0 0 1-3 3h-3a3 3 0 0 1-3-3V2.5a.3.3 0 0 0-.3-.3Z" />
