  ...
  return (
    <AdminLayout>
      <div className="space-y-6 max-w-4xl mx-auto">
        ...
        <PageHeader
          icon={Settings}
          title="ABDM & Hospital Information System Connectors"
          subtitle="Simulated endpoints for Ayushman Bharat Digital Mission (M2/M3) and hospital EHR gateways"
          badgeText="Mock Connectors"
        />
            ...
            return (
              ...
              >
                <div className="space-y-1">
                  ...
                  <p className="text-xs font-mono text-slate-500 dark:text-slate-400">{item.endpoint}</p>
                  <p className="text-[11px] text-sky-700 dark:text-sky-400 font-semibold">Mode: {item.mode}</p>
                </div>
